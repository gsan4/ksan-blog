...
const ExternalLinkIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-slate-400 group-hover:text-teal-600 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const Shortcuts: React.FC = () => {
    ...
    return (
        <div className="py-2">
            <h2 className="text-xl font-bold text-neutral-800 mb-6 tracking-tight flex items-center">
                실시간 트렌드 및 정보
            </h2>
                    ...
                    {regularLinks.map((link, index) => (
                        <li key={index}>
                            <a 
                                ...
                                className="py-3.5 px-1 flex items-center justify-between hover:bg-neutral-50/60 transition-colors duration-150 group rounded-md"
                            >
                                <div>
                                    <h3 className="font-semibold text-neutral-800 group-hover:text-black transition-colors text-base">
                                        {link.title}
                                    </h3>
                                    <p className="text-xs text-neutral-400 mt-0.5">{link.description}</p>
                                </div>
                                <ExternalLinkIcon />
                            </a>
                        </li>
